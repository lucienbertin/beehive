...
mod test {
    ...
    use super::{SmallestBeehive, SmallBeehive, MediumBeehive, recursive_generate};

    #[test]
    fn gen_smallest_beehive() -> Result<(), ()> {
        let dictionary = Dictionary::new().map_err(|_e| ())?;

        let empty_beehive = SmallestBeehive {
            words: vec![]
        };

        let res = recursive_generate(&dictionary, empty_beehive);
    ...
    #[test]
    fn gen_small_beehive() -> Result<(), ()> {
        let dictionary = Dictionary::new().map_err(|_e| ())?;

        let empty_beehive = SmallBeehive {
            words: vec![]
        };
    ...
    #[test]
    fn gen_medium_beehive() -> Result<(), ()> {
        let dictionary = Dictionary::new().map_err(|_e| ())?;

        let empty_beehive = MediumBeehive {
            words: vec![]
        };
